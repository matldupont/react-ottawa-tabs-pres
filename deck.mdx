...
https://welcoming-site.netlify.app/
...
## Keyboard Interactions and ARIA Authoring Pracices
...
2. Solved by implementing functionality for the arrow keys to move between tabs and the tab key to enter the visible content then exist below.
...
This also goes against the general rule of avoiding making non-interactive elements focusable.
